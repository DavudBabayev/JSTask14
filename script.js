...
const navSecond = document.querySelector(".second");
...
window.addEventListener('scroll', () => {
    ...
    greenDiv.querySelector(".firstcon").style.display = isScrolled ? "none" : "flex";
...
createToyElement('.sec2third', stuffedAnimals);
